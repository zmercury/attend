            ...
            <div className="container mx-auto px-4 py-12 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl font-light">
                        Transform how you track attendance with our intelligent platform.
                        Designed for modern schools, built for efficiency.
                    </p>
                    ...
                    <div className="flex items-center space-x-8 pt-8 text-sm text-muted-foreground">
                        <div className="flex items-center">
                            <div className="flex -space-x-2">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="w-8 h-8 rounded-full border-2 border-background bg-gradient-to-r from-purple-400 to-pink-500" />
                                ))}
                            </div>
